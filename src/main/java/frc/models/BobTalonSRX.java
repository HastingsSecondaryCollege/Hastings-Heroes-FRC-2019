...
public class BobTalonSRX extends TalonSRX {
    ...
    //NB: SensorDifference = Diff0 - Diff1
	public void configSensorDiff(FeedbackDevice feedbackDevice0, FeedbackDevice feedbackDevice1) {
	...
	public ErrorCode setSecondarySensorPosition(int sensorPos) {
		return super.setSelectedSensorPosition(sensorPos, secondaryPidIndex, defaultTimeoutMs);
	}
	...
	public int getSecondaryClosedLoopError() {
		return super.getClosedLoopError(secondaryPidIndex);
	}
