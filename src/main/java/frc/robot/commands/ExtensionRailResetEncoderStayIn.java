...
public class ExtensionRailResetEncoderStayIn extends Command {
  public ExtensionRailResetEncoderStayIn() { 
  ...
  protected void end() {
    ...
    Robot.TalonExtensionRail.set(ControlMode.Position, RobotMap.RAIL_RETRACTED);
