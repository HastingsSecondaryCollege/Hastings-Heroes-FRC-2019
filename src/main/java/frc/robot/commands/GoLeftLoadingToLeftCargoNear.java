...
public class GoLeftLoadingToLeftCargoNear extends CommandGroup {
  /**
   * Add your docs here.
   */
  public GoLeftLoadingToLeftCargoNear() {
    // Add Commands here:
    ...
    trajectoriesToJoin[1].trajectoryFilename = "/home/lvuser/motionprofiles/LeftReversedFromLoadingBayToLeftCargoNear2.dat";
    trajectoriesToJoin[1].td = 40;
    trajectoriesToJoin[1].usePigeonIMU = true;
    trajectoriesToJoin[1].inReverse = false;
/*    trajectoriesToJoin[2] = new FollowArc.FollowArcTrajectory();
    trajectoriesToJoin[2].trajectoryFilename = "/home/lvuser/motionprofiles/East1Meter.dat";
    trajectoriesToJoin[2].td = 10;
    trajectoriesToJoin[2].usePigeonIMU = true;
    trajectoriesToJoin[2].inReverse = false;*/
    ...
    addSequential(new FollowArc("/home/lvuser/motionprofiles/LeftReversedFromLoadingBayToLeftCargoNear.dat",60,true,false));		
    */ 
